...
def mask(
    ...
    mask01, used_backend, backend_error = skin_mask_dispatch_info(
        ...
        mhp_model_path=settings.mhp_model_path,
        mhp_input_size=settings.mhp_input_size,
        mhp_skin_class_ids=tuple(settings.mhp_skin_class_ids),
        mhp_min_confidence=settings.mhp_min_confidence,
        mhp_input_name=settings.mhp_input_name,
        mhp_output_name=settings.mhp_output_name,
        mhp_input_bgr=settings.mhp_input_bgr,
        mhp_norm_mean=tuple(settings.mhp_norm_mean),
        mhp_norm_std=tuple(settings.mhp_norm_std),
